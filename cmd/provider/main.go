...
import (
	...
	apisCluster "github.com/disaster37/provider-rancher2/apis/cluster"
	apisNamespaced "github.com/disaster37/provider-rancher2/apis/namespaced"
	"github.com/disaster37/provider-rancher2/config"
	"github.com/disaster37/provider-rancher2/internal/clients"
	controllerCluster "github.com/disaster37/provider-rancher2/internal/controller/cluster"
	controllerNamespaced "github.com/disaster37/provider-rancher2/internal/controller/namespaced"
	"github.com/disaster37/provider-rancher2/internal/features"
	"github.com/disaster37/provider-rancher2/internal/version"
)
...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Rancher2").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-rancher2"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-rancher2",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Rancher2 APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Rancher2 APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Rancher2 controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Rancher2 controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Rancher2 controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Rancher2 controllers")
	}
