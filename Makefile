...
PROJECT_NAME ?= provider-rancher2
PROJECT_REPO ?= github.com/disaster37/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 13.1.4
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-rancher2
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-rancher2_v${TERRAFORM_PROVIDER_VERSION}
...
xpkg.build.provider-rancher2: do.build.images
