...
type AppV2InitParameters struct {
	...
	// Repo name
	// +crossplane:generate:reference:type=github.com/disaster37/provider-rancher2/apis/namespaced/app/v1alpha1.CatalogV2
	RepoName *string `json:"repoName,omitempty" tf:"repo_name,omitempty"`

	// Reference to a CatalogV2 in app to populate repoName.
	// +kubebuilder:validation:Optional
	RepoNameRef *v1.NamespacedReference `json:"repoNameRef,omitempty" tf:"-"`

	// Selector for a CatalogV2 in app to populate repoName.
	// +kubebuilder:validation:Optional
