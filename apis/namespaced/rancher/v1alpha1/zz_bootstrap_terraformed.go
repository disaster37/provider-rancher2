...
func (tr *Bootstrap) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"current_password": "status.atProvider.currentPassword", "initial_password": "initialPasswordSecretRef", "password": "passwordSecretRef", "temp_token": "status.atProvider.tempToken", "token": "status.atProvider.token"}
}
