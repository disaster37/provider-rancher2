...
func (tr *NodeDriver) GetObservation() (map[string]any, error) {
...
func (tr *NodeDriver) SetObservation(obs map[string]any) error {
...
func (tr *NodeDriver) GetParameters() (map[string]any, error) {
...
func (tr *NodeDriver) SetParameters(params map[string]any) error {
...
// GetInitParameters of this NodeDriver
func (tr *NodeDriver) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NodeDriver
func (tr *NodeDriver) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
