...
type BootstrapInitParameters struct {
	...
	InitialPasswordSecretRef *v1.LocalSecretKeySelector `json:"initialPasswordSecretRef,omitempty" tf:"-"`
...
// Bootstrap is the Schema for the Bootstraps API. Provides a Rancher v2 bootstrap resource. This can be used to bootstrap Rancher v2 environments and output information. It just works if
