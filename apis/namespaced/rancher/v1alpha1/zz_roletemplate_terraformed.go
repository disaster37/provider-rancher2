...
func (tr *RoleTemplate) GetObservation() (map[string]any, error) {
...
func (tr *RoleTemplate) SetObservation(obs map[string]any) error {
...
func (tr *RoleTemplate) GetParameters() (map[string]any, error) {
...
func (tr *RoleTemplate) SetParameters(params map[string]any) error {
...
// GetInitParameters of this RoleTemplate
func (tr *RoleTemplate) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RoleTemplate
func (tr *RoleTemplate) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
