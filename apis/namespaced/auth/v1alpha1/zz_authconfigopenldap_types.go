...
type AuthConfigOpenldapInitParameters struct {
	...
	ServiceAccountDistinguishedNameSecretRef v1.LocalSecretKeySelector `json:"serviceAccountDistinguishedNameSecretRef" tf:"-"`
...
type AuthConfigOpenldapObservation struct {
...
type AuthConfigOpenldapParameters struct {
...
// AuthConfigOpenldapSpec defines the desired state of AuthConfigOpenldap
type AuthConfigOpenldapSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AuthConfigOpenldapParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AuthConfigOpenldapInitParameters `json:"initProvider,omitempty"`
}

// AuthConfigOpenldapStatus defines the observed state of AuthConfigOpenldap.
type AuthConfigOpenldapStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AuthConfigOpenldapObservation `json:"atProvider,omitempty"`
}
...
// AuthConfigOpenldap is the Schema for the AuthConfigOpenldaps API. Provides a Rancher v2 Auth Config OpenLdap resource. This can be used to configure and enable Auth Config OpenLdap for Rancher v2 RKE clusters and retrieve their information.
...
type AuthConfigOpenldap struct {
	...
	Spec   AuthConfigOpenldapSpec   `json:"spec"`
	Status AuthConfigOpenldapStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AuthConfigOpenldapList contains a list of AuthConfigOpenldaps
type AuthConfigOpenldapList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AuthConfigOpenldap `json:"items"`
}

// Repository type metadata.
var (
	AuthConfigOpenldap_Kind             = "AuthConfigOpenldap"
	AuthConfigOpenldap_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AuthConfigOpenldap_Kind}.String()
	AuthConfigOpenldap_KindAPIVersion   = AuthConfigOpenldap_Kind + "." + CRDGroupVersion.String()
	AuthConfigOpenldap_GroupVersionKind = CRDGroupVersion.WithKind(AuthConfigOpenldap_Kind)
)

func init() {
	SchemeBuilder.Register(&AuthConfigOpenldap{}, &AuthConfigOpenldapList{})
}
