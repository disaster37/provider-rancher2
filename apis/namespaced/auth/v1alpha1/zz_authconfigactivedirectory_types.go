...
type AuthConfigActivedirectoryInitParameters struct {
	...
	ServiceAccountPasswordSecretRef v1.LocalSecretKeySelector `json:"serviceAccountPasswordSecretRef" tf:"-"`

	// Service account DN for access ActiveDirectory service (string)
	ServiceAccountUsernameSecretRef v1.LocalSecretKeySelector `json:"serviceAccountUsernameSecretRef" tf:"-"`
	...
	TestPasswordSecretRef v1.LocalSecretKeySelector `json:"testPasswordSecretRef" tf:"-"`
